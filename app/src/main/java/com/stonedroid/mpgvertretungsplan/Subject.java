...
public class Subject {
    private static final Map<String, List<String>> subjects = ImmutableMap.<String, List<String>>builder()
            ...
            .put("Chemie", Arrays.asList("Ch1", "Ch2", "ch1", "ch2", "ch3"))
            ...
            .put("Gemeinschaftskunde", Arrays.asList("Gk1", "gk1", "gk2", "gk3", "gk4", "gk5"))
            .put("Geographie", Arrays.asList("Geo1", "geo1", "geo2", "geo3", "geo4"))
            .put("Geschichte", Arrays.asList("G1", "g1", "g2", "g3", "g4", "g5"))
            .put("Informatik", Arrays.asList("inf1", "inf2"))
            .put("Italienisch", Arrays.asList("Ital1"))
            .put("Kunst", Arrays.asList("Bk1", "bk1", "bk2", "bk3"))
            .put("Latein", Arrays.asList("L1"))
            .put("Mathematik", Arrays.asList("M1", "M2", "M3", "M4", "M5"))
            .put("Musik", Arrays.asList("Mu1", "mu1", "mu2"))
            .put("Philosophie", Arrays.asList("phil1"))
            .put("Physik", Arrays.asList("Ph1", "ph1", "ph2"))
            .put("Psychologie", Arrays.asList("psy1", "psy2", "psy3"))
            .put("Religion", Arrays.asList("rev1", "rev2", "rev3", "rrk1"))
            .put("Sport", Arrays.asList("Sp1", "sp1", "sp2", "sp3", "sp4", "sp5"))
